...
rollie = User.create(name: 'Rollie', email: 'rollie@rollie.com', password: age: 15, 'password', city: new_york, soundcloud: '<iframe width="100%" height="80" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/252456641&amp;auto_play=false&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;visual=true"></iframe>')
