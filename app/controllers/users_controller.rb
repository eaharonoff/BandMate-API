class UsersController < ApplicationController
  ...
  def show
    ...
    render json: user, include: ["name", "zip", "age", "bio", "genres", "instruments", "soundcloud", "sent_requests", "sent_requests.recipient", "received_requests", "received_requests.sender", "friends", "friends.genres", "friends.instruments", "inverse_friends", "inverse_friends.genres", "inverse_friends.instruments"]
  end
