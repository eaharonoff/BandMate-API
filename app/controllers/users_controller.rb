class UsersController < ApplicationController
  ...
  def create
    ...
    render json: user, include: ["name", "zip", "age", "bio", "genres", "instruments", "sent_requests", "sent_requests.recipient", "received_requests", "received_requests.sender", "friends", "friends.genres", "friends.instruments", "inverse_friends", "inverse_friends.genres", "inverse_friends.instruments", "conversations"]
  end

  def show
    user = User.find(params[:id])
    render json: user, include: ["name", "zip", "age", "bio", "genres", "instruments", "friends", "friends.genres", "friends.instruments", "inverse_friends", "inverse_friends.genres", "inverse_friends.instruments"]
  end
